...
def text_to_sql(query):
    result = agent_executor.run(query + " Proceed until you answer the question or say that you don't know, don't ask my permission, explain your thought process. Please think carefully about your answer and analyse it a couple of times before responding")
    return result
